...
if (tiempoDibujo > tiempoescritura) {
delayMicroseconds(193 + tiempoDibujo + tiempoescritura * pgm_read_word_near(numpasos + 0) / (360 - pgm_read_word_near(numpasos + 0)));
} else {
delayMicroseconds(193 + tiempoDibujo * 360 / (360 - pgm_read_word_near(numpasos + 0)));
}
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
if (tvariable > 800000 || tvariable < -800000) {
tvariable = 0;
}
return;
}
